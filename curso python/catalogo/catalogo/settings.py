...
ALLOWED_HOSTS = ['catalogojairo.herokuapp.com']
...
#Identificador o definir el perfil  de los usuarios
...
EMAIL_PORT = '587'
EMAIL_HOST_USER = 'jackskk34@gmail.com' #ponen su correo
EMAIL_HOST_PASSWORD = 'simulatorbmx' #poner la clave de su correo
EMAIL_USE_TLS = True
